...
from iparam_identification.trajectory import (
    CollisionChecker,
    CollisionConfig,
    ExcitationOptimizer,
    JointLimits,
...
from iparam_identification.trajectory.constraints import _TrajectoryCache
...
class TestConstraints:
    ...
    def test_small_amplitude_satisfies_joint_limits(self, kinematics):
        ...
        from iparam_identification.trajectory.constraints import (
